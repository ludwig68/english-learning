    ...
    <footer class="border-t border-slate-200 bg-white mt-8">
        <div class="max-w-6xl mx-auto px-4 py-8 grid gap-6 md:grid-cols-4 text-xs text-slate-600">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="/index.php" class="hover:text-[#16a34a] flex items-center gap-2"><i class="fa-solid fa-house text-[0.7rem] text-slate-300"></i> Trang chủ</a></li>
                    <li><a href="/user/learn.php" class="hover:text-[#16a34a] flex items-center gap-2"><i class="fa-solid fa-road text-[0.7rem] text-slate-300"></i> Lộ trình Level</a></li>
                    <li><a href="/user/flashcard.php?level_id=1" class="hover:text-[#16a34a] flex items-center gap-2"><i class="fa-regular fa-clone text-[0.7rem] text-slate-300"></i> Flashcard</a></li>
                    <li><a href="/user/practice.php?level_id=1" class="hover:text-[#16a34a] flex items-center gap-2"><i class="fa-solid fa-clipboard-question text-[0.7rem] text-slate-300"></i> Practice</a></li>
                    <li><a href="/auth/login.php" class="hover:text-[#16a34a] flex items-center gap-2"><i class="fa-solid fa-right-to-bracket text-[0.7rem] text-slate-300"></i> Đăng nhập</a></li>
                    <li><a href="/auth/register.php" class="hover:text-[#16a34a] flex items-center gap-2"><i class="fa-solid fa-user-plus text-[0.7rem] text-slate-300"></i> Đăng ký</a></li>
                </ul>
            </div>
